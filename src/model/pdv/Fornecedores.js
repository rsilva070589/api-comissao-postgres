...
const getAll = (request, response) => {
  ...
  queryGetAll = 'SELECT * from "' +schemaUsuario+'".fornecedores ;'
...
const update = (request, response) => {
  ...
  database.pool.query(
    'UPDATE "' +schemaUsuario+'".produtos SET CATEGORIA = $1, CODIGO_BARRAS = $2,DESCRICAO = $3,FOTO = $4,NOME = $5,SITUACAO = $6,VALOR = $7,VALOR_CUSTO = $8,QTDE_ESTOQUE = $9,QTDE_ESTOQUE = $10 WHERE id = $11',
    [CATEGORIA, CODIGO_BARRAS,DESCRICAO,FOTO,NOME,SITUACAO,VALOR,VALOR_CUSTO,QTDE_ESTOQUE,COD_PRODUTO,id],
    (error, results) => {
      if (error) {
